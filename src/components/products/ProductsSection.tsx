      ...
      <div className="max-w-[1320px] mx-auto px-6 relative z-10">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {products.map((product) => (
              <ProductCard key={product.id} product={product} isPrimary={product.id === 'ai-build'} />
            ))}
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-[#05101A] border border-[#1A2E44] rounded-xl p-6 hover:border-[#8CC63F]/40 hover:bg-[#071625] transition-colors flex items-center gap-4">
  ...
  return (
    <GlassCard 
      ...
      className={cn(
        ...
        isPrimary ? "lg:-translate-y-4 shadow-[0_0_30px_rgba(0,217,255,0.1)]" : "opacity-90 hover:opacity-100"
      )}
    >
      <div className={cn(
        "p-8 border-b",
        ...
        <div className={cn(
          "w-full h-24 rounded-lg border flex flex-col overflow-hidden opacity-80",
          ...
          <div className="flex-1 p-2 flex gap-2">
            <div className={cn(
              "w-1/4 h-full rounded opacity-20",
            ...
            <div className="flex-1 h-full flex flex-col gap-1.5">
              <div className={cn(
                "w-3/4 h-2 rounded opacity-30",
                product.theme === 'cyan' ? "bg-[#00D9FF]" :
                product.theme === 'green' ? "bg-[#8CC63F]" :
                "bg-[#A855F7]"
              )}></div>
              <div className={cn(
                "w-1/2 h-2 rounded opacity-20",
                product.theme === 'cyan' ? "bg-[#00D9FF]" :
                product.theme === 'green' ? "bg-[#8CC63F]" :
                "bg-[#A855F7]"
              )}></div>
